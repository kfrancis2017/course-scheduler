...
public class CourseList {
    ...
    public boolean addCourse(String courseName, String courseID, String description, ArrayList<ArrayList<String>> prereq, ArrayList<ArrayList<String>> coreq, String AOS_Req, boolean holds) {
        if (findCourseByCode(courseID) != null) return false;
        courses.add(new Course(courseName, courseID, description, prereq, coreq, AOS_Req, holds));
        return true;
    }
